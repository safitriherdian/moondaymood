...
if (isset($_POST["submit"])) {
	...
	$result = $koneksi->query("INSERT INTO produk (id_kategori,nama_produk, harga_produk, berat_produk, foto_produk, deskripsi_produk, stok_produk)
	VALUES('$_POST[id_kategori]', '$_POST[nama]', '$_POST[harga]', '$_POST[berat]', '$nama[0]', '$_POST[deskripsi]', '$_POST[stok]')");
	...
	foreach ($nama as $key => $tiap_nama) {
		...
		$hasil = $koneksi->query("INSERT INTO produk_foto(id_produk, nama_produk_foto) 
