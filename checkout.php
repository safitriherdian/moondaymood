...
<body style="min-height: 1000px;">
  ...
  <section class="content">
    <div class="container">
    <h2><strong>Checkout Sekarang Juga!</strong></h2><br>
      ...
      <form action="" method="post">
        ...
        <div class="form-group">
          <br><label for="">Alamat Lengkap Pengiriman</label>
      ...
      if (isset($_POST["checkout"])) {
        ...
        $koneksi->query("INSERT INTO pembelian(id_pelanggan, tanggal_pembelian, total_pembelian, alamat_pengiriman, status_pembelian, resi_pengiriman,totalberat, provinsi, distrik, tipe, kodepos, ekspedisi, paket, ongkir, estimasi) 
      VALUES('$id_pelanggan', '$tanggal_pembelian', '$total_pembelian', '$alamat_pengiriman', '$status_pembelian','$resi_pengiriman','$totalberat', '$provinsi', '$distrik', '$tipe', '$kodepos', '$ekspedisi', '$paket', '$ongkir', '$estimasi')");
